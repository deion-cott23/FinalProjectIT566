...
ALTER USER 'student_languages_user'@'localhost'
    REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0
    MAX_CONNECTIONS_PER_HOUR 0
    MAX_UPDATES_PER_HOUR 0
    MAX_USER_CONNECTIONS 0;
GRANT ALL PRIVILEGES ON `student\_languages\_user\_localhost`.*
    TO 'student_languages_user'@'localhost';
GRANT ALL PRIVILEGES ON `student\_languages`.*
    TO 'student_languages_user'@'localhost' WITH GRANT OPTION;
